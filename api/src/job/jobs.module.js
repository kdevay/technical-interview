...
var JobModule = exports.JobModule = function () {
    ...
    var _classThis;
    var JobModule = _classThis = /** @class */ (function () {
        function JobModule_1() {
        }
        return JobModule_1;
    }());
    __setFunctionName(_classThis, "JobModule");
    (function () {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        JobModule = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return JobModule = _classThis;
}();
